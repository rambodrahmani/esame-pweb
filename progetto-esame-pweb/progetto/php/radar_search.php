<?php
	/*
		La radar search è una funzione che ho scritto per poter salvare i dati relativi a un luogo indicizzato su Google Maps in modo da non dover ogni volta richiedere le informazioni a Google (dato che Google garantisce un numero di richieste giornalisi e per secondo limitate). In questo modo, ogni volta che un utente richiede le informazioni per un determinato numero di luoghi (massimo 200 - questo limite è imposto da Google), queste vengono salvate nel database principale e da quel momento in poi tutti gli utenti potranno utilizzarle senza dover inviare richieste alle API di Google Places. viene richiamata la funziona "radarSearch" disponibile nelle API di Google Places che restituisce 200 place_id una votla forniti una location e un raggio di azione. I 200 place_id vengono smistani su un numero variabile (ad ora 6) di VPS che provvedono a catalogare qualsiasi informazione (informaizoni base, foto, reviews e altro) relativa a quel luogo disponibile. Il database sul quale vengono eseguite le operazioni e le VPS da utilizzare sono definitivi nel file config.php.
	*/
