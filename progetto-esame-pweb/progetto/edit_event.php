<?php
	...
	$_SESSION['selected_event_id'] = $selected_event;
?>
...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="it" lang="it">
	<head>
		...
		<title>Ubi - Modifica Evento</title>
        ...
        <!-- -->
        <script type="text/javascript" src="js/load_edit_event.js"></script>
		...
		<section id="content" class="body">
	        <div id="new_event">
                ...
                <form id="event_form" class="event_form" method="post" enctype="multipart/form-data">
					...
					<p>Seleziona un'immagine da caricare:</p>
                    <input type="hidden" name="event_picture_url" id="event_picture_url" value="">
                    ...
                    <input class="event_form" type="text" name="event_place_name" id="event_place_name" onKeyPress="return edit_event_form_SubmitOnEnter(event)"><br>
                    <input type="hidden" name="edit_event_submitted" id="edit_event_submitted" value="">
                    <input class="btn_edit_event_form" name="action" type="submit" value="Modifica Evento" onClick="setEditEvent();">
                    <input type="hidden" name="delete_event_submitted" id="delete_event_submitted" value="">
                    <input class="btn_delete_event_form" name="action" type="submit" value="Elimina Evento" onClick="setDeleteEvent();">
                </form>
